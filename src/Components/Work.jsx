      ...
      <section className="container mx-auto p-5 md:p-10 lg:p-5">
        ...
        <div className="grid md:grid-cols-2 lg:w-10/12 lg:mx-auto xl:grid-cols-3  gap- gap-y-6 mt-10 text-gray-950  ">
           <div className="bg-yellow-400 rounded-lg w-10/12 p-5 mx-auto transition duration-100 hover:scale-105">
            ...
            <img src={apiimg} alt=""  className="mx-auto w-3/4 mt-3"/>
            </a>
            <div className="text-center my-2 ">
            <a className="text-xl font-bold  text-slate-800   hover:text-black  rounded-xl p-2 hover:border-b-2 hover:border-sky-700 active:border-sky-950 " target="_blank" href="https://github.com/Prathap12072003/Weather-API">view sourcecode</a>
            </div>
           ...
           <img src={vehivleimg} alt=""  className="mx-auto w-3/4"/>
            <div className="text-center my-2 ">
            <a className="text-xl font-bold  text-slate-800   hover:text-black p-2 rounded-xl hover:border-b-2 hover:border-sky-700 active:border-sky-950" target="_blank" href="https://github.com/Prathap12072003/Vehicle_Application">view sourcecode</a>
            </div>
